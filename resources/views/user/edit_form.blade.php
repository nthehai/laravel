...
<div class="content1" style="margin-left: 20px;margin-top: 20px;margin-right: 10%;">
  <div>
  <form method="post" action="{{URL::to('/update_form/'.$news->id)}}">
    ...
    <h4>Tiêu chuẩn 1. Quản trị chiến lược (100 điểm)</h4>
      ...
      <input type="number" id="1.1" name="tc_1_1" value="{{ $news->tc_1_1 }}" min="0" max="100" placeholder="Thang điểm từ 0 đến 100%" required onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="1.2" name="tc_1_2" value="{{ $news->tc_1_2 }}" min="0" max="3" required placeholder="Ví dụ:01 lần/năm học" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="1.3" name="tc_1_3" value="{{ $news->tc_1_3 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
    <strong><p style="color: #f96332;font-size: 15px;">TỔNG ĐIỂM TIÊU CHUẨN 1 LÀ : <input type="text" name="Standard_1" id="tong1" value="{{ $news->Standard_1 }}" readonly></p></strong>
    <!--   Tiêu chuẩn 2   -->
      ...
      <input type="number" id="2.1" name="tc_2_1" value="{{ $news->tc_2_1 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
      <label>2.2.Quy mô giảng viên </label><br>
      <i>Tỷ lệ giảng viên trên tổng quy mô đào tạo đại học và sau đại học.</i><br>
      <input type="number" id="2.2" name="tc_2_2" value="{{ $news->tc_2_2 }}" min="0" max="10" required placeholder="Thang điểm từ 0 đến 10%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="2.3" name="tc_2_3" value="{{ $news->tc_2_3 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
      <label>2.4.Uy tín giảng viên </label><br>
      <i>Tỷ lệ cán bộ khoa học có chức danh GS, PGS trên tổng số cán bộ khoa học cơ hữu.</i><br>
      <input type="number" id="2.4" name="tc_2_4" value="{{ $news->tc_2_4 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
      <label>2.5.Quy mô đào tạo thạc sĩ </label><br>
      <i>Tỷ lệ đào tạo thạc sĩ trên tổng quy mô đào tạo.</i><br>
      <input type="number" id="2.5" name="tc_2_5" value="{{ $news->tc_2_5 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
      <label>2.6.Quy mô đào tạo tiến sĩ </label><br>
      <i>Tỷ lệ đào tạo tiến sĩ trên tổng quy mô đào tạo.</i><br>
      <input type="number" id="2.6" name="tc_2_6" value="{{ $news->tc_2_6 }}" min="0" max="10" required placeholder="Thang điểm từ 0 đến 10%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="2.7" name="tc_2_7" value="{{ $news->tc_2_7 }}" min="0" max="5" required placeholder="Thang điểm từ 0 đến 5" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="2.8" name="tc_2_8" value="{{ $news->tc_2_8 }}" min="0" max="5" required placeholder="Thang điểm từ 0 đến 5" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="2.9" name="tc_2_9" value="{{ $news->tc_2_9 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="2.10" name="tc_2_10" value="{{ $news->tc_2_10 }}" min="0" max="10" required placeholder="Thang điểm từ 0 đến 10%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="2.11" name="tc_2_11" value="{{ $news->tc_2_11 }}" min="0" max="25" required placeholder="Chọn 2 mức 15 hoặc 25" onkeyup="tieuchuan();" pattern="[15|25]" title="Nhập 15 hoặc 25 thôi !"><br>
      <strong><p style="color: #f96332;font-size: 15px;">TỔNG ĐIỂM TIÊU CHUẨN 2 LÀ : <input type="tong2" name="Standard_2" id="tong2" value="{{ $news->Standard_2 }}" readonly></p></strong>
      <!--   Tiêu chuẩn 3   -->
      ...
      <input type="number" id="3.1" name="tc_3_1" value="{{ $news->tc_3_1 }}" min="0" max="5" required placeholder="Nhập số * đạt được ví dụ : 2.5" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="3.2" name="tc_3_2" value="{{ $news->tc_3_2 }}" min="0" max="5" required placeholder="Nhập số * đạt được ví dụ : 2.5" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="3.3" name="tc_3_3" value="{{ $news->tc_3_3 }}" min="0" max="5" required placeholder="Nhập số * đạt được ví dụ : 2.5" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="3.4" name="tc_3_4" value="{{ $news->tc_3_4 }}" min="0" max="10" required placeholder="Thang điểm từ 0 đến 10%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="3.5" name="tc_3_5" value="{{ $news->tc_3_5 }}" min="0" max="500" required placeholder="Nhập số tiền kinh phí: ví dụ 200 (đơn vị: triệu VNĐ)" onkeyup="tieuchuan();"><br>
      <strong><p style="color: #f96332;font-size: 15px;">TỔNG ĐIỂM TIÊU CHUẨN 3 LÀ : <input type="text" name="Standard_3" id="tong3" value="{{ $news->Standard_3 }} " readonly></p></strong>
      <!--   Tiêu chuẩn 4   -->
      ...
      <input type="number" id="4.1" name="tc_4_1" value="{{ $news->tc_4_1 }}" min="0" max="10" required placeholder="Nhập số giải pháp đạt được" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="4.2" name="tc_4_2" value="{{ $news->tc_4_2 }}" min="0" max="500" required placeholder="Nhập số kinh phí : ví dụ 30 ( triệu VNĐ)" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="4.3" name="tc_4_3" value="{{ $news->tc_4_3 }}" min="0" max="10" required placeholder="Nhập số doanh nghiệp khởi nghiệp" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="4.4" name="tc_4_4" value="{{ $news->tc_4_4 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="4.5" name="tc_4_5" value="{{ $news->tc_4_5 }}" min="0" max="10" required placeholder="Nhập số không gian sáng tạo" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="4.6" name="tc_4_6" value="{{ $news->tc_4_6 }}" min="0" max="10" required placeholder="Nhập trung bình số đối tác doanh nghiệp" onkeyup="tieuchuan();"><br>
      <strong><p style="color: #f96332;font-size: 15px;">TỔNG ĐIỂM TIÊU CHUẨN 4 LÀ : <input type="text" name="Standard_4" id="tong4" value="{{ $news->Standard_4 }}" readonly></p></strong>
      <!--   Tiêu chuẩn 5   -->
      ...
      <input type="number" id="5.1" name="tc_5_1" value="{{ $news->tc_5_1 }}" min="0" max="10" required placeholder="Nhập số thủ tục ( tối đa là 10)" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="5.2" name="tc_5_2" value="{{ $news->tc_5_2 }}" min="0" max="10" required placeholder="Nhập số lĩnh vực cơ bản" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="5.3" name="tc_5_3" value="{{ $news->tc_5_3 }}" min="0" max="10" required placeholder="Số tài liệu nội sinh được số hóa và cung cấp trực tuyến trên tổng số cán bộ khoa học cơ hữu/năm." onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="5.4" name="tc_5_4" value="{{ $news->tc_5_4 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="5.5" name="tc_5_5" value="{{ $news->tc_5_5 }}" min="0" max="10" required placeholder="Số kênh tương tác, hỗ trợ sinh viên học tập" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="5.6" name="tc_5_6" value="{{ $news->tc_5_6 }}" min="0" max="10" required placeholder="Trung bình số học phần có giảng dạy trực tuyến trên tổng số các chương trình đào tạo" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="5.7" name="tc_5_7" value="{{ $news->tc_5_7 }}" min="0" max="10" required placeholder="Nhập tỷ lệ số ( ví dụ 0.5)" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="5.8" name="tc_5_8" value="{{ $news->tc_5_8 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="5.9" name="tc_5_9" value="{{ $news->tc_5_9 }}" min="0" max="10" required placeholder="Số phần mềm có bản quyền để kiểm tra sự trùng lặp thông tin và đạo văn" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="5.10" name="tc_5_10" value="{{ $news->tc_5_10 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
      <strong><p style="color: #f96332;font-size: 15px;">TỔNG ĐIỂM TIÊU CHUẨN 5 LÀ : <input type="text" name="Standard_5" id="tong5" value="{{ $news->Standard_5 }}" readonly></p></strong>
      <!--   Tiêu chuẩn 6   -->
      ...
      <input type="number" id="6.1" name="tc_6_1" value="{{ $news->tc_6_1 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="6.2" name="tc_6_2" value="{{ $news->tc_6_2 }}" min="0" max="10" required placeholder="Thang điểm từ 0 đến 10%" onkeyup="tieuchuan();"><br>
      <label>6.3.Người học quốc tế </label><br>
      <i>Tỷ lệ người học có quốc tịch nước ngoài học lấy bằng trên tổng quy mô đào tạo.</i><br>
      <input type="number" id="6.3" name="tc_6_3" value="{{ $news->tc_6_3 }}" min="0" max="10" required placeholder="Thang điểm từ 0 đến 10%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="6.4" name="tc_6_4" value="{{ $news->tc_6_4 }}" min="0" max="10" required placeholder="Thang điểm từ 0 đến 10%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="6.5" name="tc_6_5" value="{{ $news->tc_6_5 }}" min="0" max="10" required placeholder="Thang điểm từ 0 đến 10%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="6.6" name="tc_6_6" value="{{ $news->tc_6_6 }}" min="0" max="10" required placeholder="Thang điểm từ 0 đến 10%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="6.7" name="tc_6_7" value="{{ $news->tc_6_7 }}" min="0" max="10" required placeholder="Thang điểm từ 0 đến 10%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="6.8" name="tc_6_8" value="{{ $news->tc_6_8 }}" min="0" max="10" required placeholder="Số lượng hội nghị, hội thảo quốc tế do khoa hoặc trường chủ trì tổ chức" onkeyup="tieuchuan();"><br>
      <label>6.9.Hợp tác quốc tế về nghiên cứu</label><br>
      <i>Tỷ lệ bài báo ISI/ Scopus có hợp tác quốc tế.</i><br>
      <input type="number" id="6.9" name="tc_6_9" value="{{ $news->tc_6_9 }}" min="0" max="100" required placeholder="Thang điểm từ 0 đến 100%" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="6.10" name="tc_6_10" value="{{ $news->tc_6_10 }}" min="0" max="100" required placeholder="Nhập kinh phí từ các dự án hợp tác quốc tế " onkeyup="tieuchuan();"><br>
      <strong><p style="color: #f96332;font-size: 15px;">TỔNG ĐIỂM TIÊU CHUẨN 6 LÀ : <input type="text" name="Standard_6" id="tong6" readonly value="{{ $news->Standard_6 }}"></p></strong>
      <!--   Tiêu chuẩn 7   -->
      ...
      <input type="number" id="7.1" name="tc_7_1" value="{{ $news->tc_7_1 }}" min="0" max="10" required placeholder="Số sản phẩm truyền thông (bài viết, talkshow, video truyền thông,…) trên các trang báo điện tử " onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="7.2" name="tc_7_2" value="{{ $news->tc_7_2 }}" min="0" max="5" required placeholder="Chọn các mức từ 1 đến 5" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="7.3" name="tc_7_3" value="{{ $news->tc_7_3 }}" min="0" max="100" required placeholder="Kinh phí tư vấn ( ví dụ 50 triệu VNĐ)" onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="7.4" name="tc_7_4" value="{{ $news->tc_7_4 }}" min="0" max="10" required placeholder="Số khoa đào tạo/năm." onkeyup="tieuchuan();"><br>
      ...
      <input type="number" id="7.5" name="tc_7_5" value="{{ $news->tc_7_5 }}" min="0" max="4" required placeholder="Chọn các mức từ 1 đến 4" onkeyup="tieuchuan();"><br>
      <strong><p style="color: #f96332;font-size: 15px;">TỔNG ĐIỂM TIÊU CHUẨN 7 LÀ : <input type="text" name="Standard_7" id="tong7" value="{{ $news->Standard_7 }}" readonly></p></strong>
      <strong><p style="color: #f96332;font-size: 15px;">TỔNG ĐIỂM TẤT CẢ 7 TIÊU CHUẨN LÀ : <input type="text" name="Tong_Diem" id="tongTatCa" value="{{ $news->Tong_Diem }}" readonly></p></strong>

      <strong><p style="color: #f96332;font-size: 15px;">SỐ SAO CÓ ĐƯỢC : <input type="text" name="gan_sao" id="ganSao" value="{{ $news->gan_sao }}" readonly></p></strong>
