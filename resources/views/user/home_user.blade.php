      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Bảng điều khiển dành cho user</a>
          </div>
      ...
      <div class="content">
        <div class="row">
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Năm 2019</h5>
                <h4 class="card-title">Tỷ lệ đánh giá</h4>
                <div class="dropdown">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Năm 2020</h5>
                <h4 class="card-title">Tỷ lệ đánh giá</h4>
                <div class="dropdown">
                  <button type="button" class="btn btn-round btn-outline-default dropdown-toggle btn-simple btn-icon no-caret" data-toggle="dropdown">
                    <i class="now-ui-icons loader_gear"></i>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Năm 2021</h5>
                <h4 class="card-title">Dự đoán</h4>
              </div>
              <div class="card-body">
                <div class="chart-area">
