      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;" style="color:red">THÊM TÀI KHOẢN MỚI</a>
          </div>
...
<!-- End Navbar -->
<div class="content">
 <form method="post" action="{{URL::to('/admin/news/store')}}">
    ...
    <p>
        ...
        <input type="text" name="ten_dv" value="">
    </p>
    <p>
    ...
    <p>
        ...
        <input type="text" name="thong_tin" value="">
    </p>
    <p>
        <label for="created_at">Ngày tạo</label><br>
        <input type="date" name="created_at" value="">
    </p>
    
    <p>
        <button type="submit" id="button_tao">Tạo trường mới</button>
    </p>
</form>
</div>     
</div>
