      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;" style="color:red">DANH SÁCH CÁC TRƯỜNG</a>
          </div>
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="{{URL::to('/admin/news/edit/'.$row->id)}}">Edit</a><br>

                          <a onclick="return confirm('Bạn có muốn xóa trường này không?')" href="{{URL::to('/delete/'.$row->id)}}" class="active styling-edit" ui-toggle-class="">Delete</a> 
                        </td>
                    </tr>
                    @endforeach
                </tbody>
